...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202304121357-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Apr 12, 2023 13:57 EDT
# @@File             :  install.sh
...
export DATADIR="$HOME/.local/share/srv/docker/opengist/rootfs"
...
HUB_IMAGE_URL="thomiceli/opengist"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default: [opengist.$SET_HOST_FULL_HOST] [$SET_HOST_FULL_DOMAIN]
CONTAINER_HOSTNAME=""
