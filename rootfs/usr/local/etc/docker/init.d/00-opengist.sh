...
# root user name
root_user_name="${OPENGIST_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${OPENGIST_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${OPENGIST_USER_NAME:-}"
# normal user password
user_pass="${OPENGIST_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - -
